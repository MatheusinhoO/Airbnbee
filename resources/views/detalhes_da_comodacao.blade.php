...
<body>
    <div class="container">
        ...
        <form action="{{ route('locacao.salva')}}" method="POST">
        @csrf
            <div class="form-group">
                <label for="titulo">Título do Anúncio <span class="required">*</span></label>
                <input type="text" id="titulo" name="titulo" placeholder="Ex: Apartamento aconchegante no centro" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="destaques" name="destaques" placeholder="Ex: Piscina, Wi-Fi rápido, Vista para o mar">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" id="horario_check_in" name="horario_check_in" required>
            </div>

            <div class="form-group">
                <label for="horario_check_out">Data de Check-out <span class="required">*</span></label>
                <input type="date" id="horario_check_out" name="horario_check_out" required>
            </div>

            <button type="submit" class="btn-submit">Salvar Informações Básicas</button>
        </form>
