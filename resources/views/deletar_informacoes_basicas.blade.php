...
<body>
    <div class="container">
        ...
        <form action="{{route('apaga_informacoes_basicas')}}" method="POST">
        @csrf
        ...
        <input type="text" class="d-none" name="id_informacao" id="id_informacao" value={{ $informacao->id }}>
            <div class="form-group">
                ...
                <select id="propriedade_tipo" name="propriedade_tipo" disabled>
            ...
            <div class="form-group">
                ...
                <select id="acomodacoes_tipo" name="acomodacoes_tipo" disabled>
            ...
            <div class="form-group">
                ...
                <input type="number" id="capacidade_hospedes" name="capacidade_hospedes" min="1" max="50" value={{ $informacao->capacidade_hospedes }} disabled>
            </div>

            <div class="row">
                <div class="form-group">
                    <label for="quartos_quantidade">Quartos <span class="required">*</span></label>
                    <input type="number" id="quartos_quantidade" name="quartos_quantidade" min="0" max="20" value={{ $informacao->quartos_quantidade }} disabled>
                </div>

                <div class="form-group">
                    <label for="camas_quantidade">Camas <span class="required">*</span></label>
                    <input type="number" id="camas_quantidade" name="camas_quantidade" min="1" max="50" value={{ $informacao->camas_quantidade }} disabled>
                </div>
            </div>

            <div class="form-group">
                <label for="banheiros_quantidade">Banheiros <span class="required">*</span></label>
                <input type="number" id="banheiros_quantidade" name="banheiros_quantidade" min="1" max="20" step="1" value={{ $informacao->banheiros_quantidade }} disabled> 
            </div>

            <div class="form-group">
                <label for="preco_noite">Preço por Noite (R$) <span class="required">*</span></label>
                <input type="number" id="preco_noite" name="preco_noite" min="0" step="50" value={{ $informacao->preco_noite }} disabled>
            </div>

            <div class="form-group">
                <label for="politica_cancelamento">Política de Cancelamento <span class="required">*</span></label>
                <select id="politica_cancelamento" name="politica_cancelamento" disabled>
            ...
            <button type="submit" class="btn-submit">Deletar Informações Basicas</button>
        </form>
