...
<body>
    <div class="container">
        ...
        <form action="{{ route('apaga_detalhe_comodacoes') }}" method="POST">
        @csrf
        ...
        <input type="text" class="d-none" name="id_detalhe" id="id_detalhe" value={{ $detalhe->id }}>
            ...
            <div class="form-group">
                ...
                <input type="text" id="titulo" name="titulo" placeholder="Ex: Apartamento aconchegante no centro" value="{{ $detalhe->titulo }}" disabled>
            </div>

            <div class="form-group">
                <label for="descricao">Descrição Detalhada <span class="required">*</span></label>
                <textarea id="descricao" name="descricao" rows="5" placeholder="Descreva sua propriedade, o que a torna especial, a vizinhança, etc." disabled>{{ $detalhe->descricao }}</textarea>
            </div>

            <div class="form-group">
                <label for="destaques">Destaques (separados por vírgula)</label>
                <input type="text" id="destaques" name="destaques" placeholder="Ex: Piscina, Wi-Fi rápido, Vista para o mar" value="{{ $detalhe->titulo }}" disabled>
            </div>

            <div class="form-group">
                <label for="comodidade_oferecidas">Comodidades Oferecidas <span class="required">*</span></label>
                <select id="comodidade_oferecidas" name="comodidade_oferecidas" disabled>
            ...
            <div class="form-group">
                ...
                <select id="permite_fumar" name="permite_fumar" disabled>
            ...
            <div class="form-group">
                ...
                <select id="permite_festa" name="permite_festa" disabled>
            ...
            <div class="form-group">
                ...
                <select id="permite_animais" name="permite_animais" disabled>
            ...
            <div class="form-group">
                ...
                <input type="date" id="horario_check_in" name="horario_check_in"  value="{{ $detalhe->horario_check_in }}" disabled>
            </div>

            <div class="form-group">
                <label for="horario_check_out">Data de Check-out <span class="required">*</span></label>
                <input type="date" id="horario_check_out" name="horario_check_out"  value="{{ $detalhe->horario_check_out }}" disabled>
            </div>

            <button type="submit" class="btn-submit">Deletar Detalhes da Comodação</button>
        </form>
